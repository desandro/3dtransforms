...
Whereas @translateX()@ positions an element along the horizontal X axis, @translateX()@ positions it along the Z axis, which runs front to back in 3D space. Positive values position the element closer to the viewer, negative values further away.
