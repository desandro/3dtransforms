...
To resolve the distortion and restore pixel perfection on this @#cube@, we can push back the 3D object, so that the front face will be positioned back at the Z origin.
...
Now apply basic styles. Let's give each panel of the @#carousel@ 20px gaps between one another. The effective width of each panel remains 210px.
