...
#box figure:nth-child(1) { -webkit-transform: translateZ( 100px ); }
...
To resolve this issue, we can push back the box, so that the front face will be positioned back at the Z origin.
